...
<div class="ssp-inline-container ssp-theme-<?php echo esc_attr( $color_scheme ); ?> ssp-shape-<?php echo esc_attr( $button_shape ); ?>">
	<span class="ssp-inline-title">Share this post:</span>
	<div class="ssp-button-wrap">
		...
		?>
			<a href="<?php echo esc_url( $share_links[ $platform ] ); ?>" class="ssp-btn ssp-<?php echo esc_attr( $platform ); ?>" target="_blank" rel="noopener noreferrer" aria-label="Share on <?php echo ucfirst( esc_attr( $platform ) ); ?>">
				...
				<span class="ssp-platform-text"><?php echo ucfirst( esc_html( $platform ) ); ?></span>
			</a>
		<?php endforeach; ?>
	</div>
</div>
